(() => {
  const initTabs = (tabsComponent) => {
    ...
    tabsComponent.dataset.ui5h3llTabsInitialized = true;
    tabsComponent.dispatchEvent(new CustomEvent('ui5h3ll:initialized'));
  };

  if (window.ui5h3ll) {
    window.ui5h3ll.register('tabs', '.tabs:not([data-ui5h3ll-tabs-initialized])', initTabs);
  }
})();
