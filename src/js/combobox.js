(() => {
  const initCombobox = (combobox) => {
    ...
    combobox.dataset.ui5h3llComboboxInitialized = true;
    combobox.dispatchEvent(new CustomEvent('ui5h3ll:initialized'));
  };

  if (window.ui5h3ll) {
    window.ui5h3ll.register('combobox', '.combobox:not([data-ui5h3ll-combobox-initialized])', initCombobox);
  }
})();
