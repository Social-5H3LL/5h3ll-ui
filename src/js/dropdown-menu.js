(() => {
  const initDropdownMenu = (dropdownMenuComponent) => {
    ...
    dropdownMenuComponent.dataset.ui5h3llDropdownMenuInitialized = true;
    dropdownMenuComponent.dispatchEvent(new CustomEvent('ui5h3ll:initialized'));
  };

  if (window.ui5h3ll) {
    window.ui5h3ll.register('dropdown-menu', '.dropdown-menu:not([data-ui5h3ll-dropdown-menu-initialized])', initDropdownMenu);
  }
})();
