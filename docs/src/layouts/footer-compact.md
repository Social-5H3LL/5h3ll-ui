...
description: Compact footer with bold nav links and social rows.
icon: rows-3
toc:
  - label: Overview
    id: overview
...
<div class="prose">
  <p>The <strong>Footer compact</strong> layout is composed from 5H3LL-UI semantic tokens and existing components. Hook class: <code>layout-footer-compact</code>.</p>
</div>
...
{% set code %}
{% include "partials/layouts/footer-compact.njk" %}
{% endset %}
{{ code_preview("layout-footer-compact", code, "w-full") }}
