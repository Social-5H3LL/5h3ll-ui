...
description: Multi-column footer with large watermark typography.
icon: columns-3
toc:
  - label: Overview
    id: overview
...
<div class="prose">
  <p>The <strong>Footer columns</strong> layout is composed from 5H3LL-UI semantic tokens and existing components. Hook class: <code>layout-footer-columns</code>.</p>
</div>
...
{% set code %}
{% include "partials/layouts/footer-columns.njk" %}
{% endset %}
{{ code_preview("layout-footer-columns", code, "w-full") }}
