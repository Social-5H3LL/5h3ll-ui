...
description: Community section with vertical marquee testimonial columns.
...
<div class="prose">
  <p>The <strong>Community testimonials</strong> layout is composed from 5H3LL-UI semantic tokens and existing components. Hook class: <code>layout-community-testimonials</code>.</p>
</div>
...
{% set code %}
{% include "partials/layouts/community-testimonials.njk" %}
{% endset %}
{{ code_preview("layout-community-testimonials", code, "w-full") }}
