...
description: Dark premium footer with newsletter form and brand logo.
icon: panel-bottom
toc:
  - label: Overview
    id: overview
...
<div class="prose">
  <p>The <strong>Footer premium</strong> layout is composed from 5H3LL-UI semantic tokens and existing components. Hook class: <code>layout-footer-premium</code>.</p>
</div>
...
{% set code %}
{% include "partials/layouts/footer-premium.njk" %}
{% endset %}
{{ code_preview("layout-footer-premium", code, "w-full") }}
