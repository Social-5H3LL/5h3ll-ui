...
title: Features tabs
description: Productivity tabs layout using the 5H3LL-UI tabs component with four panels.
icon: panel-top
toc:
  - label: Overview
    id: overview
...
<div class="prose">
  <p>The <strong>Features tabs</strong> layout is composed from 5H3LL-UI semantic tokens and existing components. Hook class: <code>layout-features-tabs</code>.</p>
</div>
...
{% set code %}
{% include "partials/layouts/features-tabs.njk" %}
{% endset %}
{{ code_preview("layout-features-tabs", code, "w-full") }}
