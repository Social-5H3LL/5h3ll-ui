...
description: Horizontally scrollable testimonial cards with pravatar avatars.
...
<div class="prose">
  <p>The <strong>Testimonial carousel</strong> layout is composed from 5H3LL-UI semantic tokens and existing components. Hook class: <code>layout-testimonial-carousel</code>.</p>
</div>
...
{% set code %}
{% include "partials/layouts/testimonial-carousel.njk" %}
{% endset %}
{{ code_preview("layout-testimonial-carousel", code, "w-full") }}
