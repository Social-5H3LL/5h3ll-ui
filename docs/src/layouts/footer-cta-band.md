...
title: Footer CTA band
description: CTA band above compact footer card.
icon: megaphone
toc:
  - label: Overview
    id: overview
...
<div class="prose">
  <p>The <strong>Footer CTA band</strong> layout is composed from 5H3LL-UI semantic tokens and existing components. Hook class: <code>layout-footer-cta-band</code>.</p>
</div>
...
{% set code %}
{% include "partials/layouts/footer-cta-band.njk" %}
{% endset %}
{{ code_preview("layout-footer-cta-band", code, "w-full") }}
