...
title: Footer serif
description: Serif-styled minimal footer variant.
icon: type
toc:
  - label: Overview
    id: overview
...
<div class="prose">
  <p>The <strong>Footer serif</strong> layout is composed from 5H3LL-UI semantic tokens and existing components. Hook class: <code>layout-footer-serif</code>.</p>
</div>
...
{% set code %}
{% include "partials/layouts/footer-serif.njk" %}
{% endset %}
{{ code_preview("layout-footer-serif", code, "w-full") }}
