...
description: Masonry-style scrolling testimonial wall.
icon: brick-wall
toc:
  - label: Overview
    id: overview
...
<div class="prose">
  <p>The <strong>Testimonials wall</strong> layout is composed from 5H3LL-UI semantic tokens and existing components. Hook class: <code>layout-testimonials-wall</code>.</p>
</div>
...
{% set code %}
{% include "partials/layouts/testimonials-wall.njk" %}
{% endset %}
{{ code_preview("layout-testimonials-wall", code, "w-full") }}
