...
<div class="prose">
  <p>5H3LL-UI uses <a href="https://lucide.dev" target="_blank">Lucide icons</a>. You have three options:</p>
...
<div class="prose">
  <p>5H3LL-UI does not ship web fonts by default. The 5H3LL-UI docs site uses the same font choices as the current shadcn/ui site: <a href="https://fonts.google.com/specimen/Geist" target="_blank">Geist Sans</a> for sans and heading text, and <a href="https://fonts.google.com/specimen/Geist+Mono" target="_blank">Geist Mono</a> for monospace text.</p>
  <p>To use the same setup, load the fonts and override the font tokens after importing 5H3LL-UI:</p>
</div>
...
<div class="prose">
  <p>Keep font overrides in a small CSS file imported after 5H3LL-UI. This makes fonts a project-level customization instead of a package default.</p>
</div>

<h2 id="custom-styles"><a href="#custom-styles">Custom styles</a></h2>

<div class="prose">
  <p>5H3LL-UI style packs combine shared structure with visual rules for each component. If you want to write a full custom style, import the styleless base and then your own style file.</p>
</div>

{% set code %}@import "tailwindcss";
@import "@social-5h3ll/5h3ll-ui/base";
@import "./style-acme.css";{% endset %}
{{ code_block(code, "css") }}

<div class="prose">
  <p><code>@social-5h3ll/5h3ll-ui/base</code> includes tokens, semantic utilities, and component structure, but no Vega/Nova/Maia/etc. visual style pack. Your style file is responsible for component visuals such as colors, radius, shadows, focus rings, spacing, and variant treatment.</p>
  <p>The practical way to start is to copy one existing style pack, rename it, and edit from there. The style files live in <code>src/css/styles/</code> and are also published under <code>@social-5h3ll/5h3ll-ui/styles/*</code>.</p>
</div>

{% set code %}@import "@social-5h3ll/5h3ll-ui/base";
@import "./style-acme.css";

/* style-acme.css can start as a copy of @social-5h3ll/5h3ll-ui/styles/nova. */{% endset %}
{{ code_block(code, "css") }}

<div class="prose">
  <p>Do not load a full 5H3LL-UI style bundle and then override it wholesale. For example, avoid importing <code>@social-5h3ll/5h3ll-ui/nova</code> before your custom style. That loads Nova component visuals and forces your file to undo them. Use <code>@social-5h3ll/5h3ll-ui/base</code> instead.</p>
</div>
...
<div class="prose">
  ...
  <p><b>If you want to make more drastic changes</b>, you can <a href="https://github.com/social-5h3ll/5h3ll-ui/blob/main/src/css/5h3ll_ui.css" target="_blank">copy the <code>5h3ll_ui.css</code> file</a> into your project and make your changes there.</p>
</div>
