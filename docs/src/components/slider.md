...
<section class="prose">
  <p>Use a native <code>&lt;input type="range"&gt;</code> with the <code>input</code> class. Include <code>range.js</code> so 5H3LL-UI can keep the filled track in sync with the input value.</p>
</section>
...
<script src="https://cdn.jsdelivr.net/npm/@social-5h3ll/5h3ll-ui@{{ pkg.version }}/dist/js/range.min.js" defer></script>{% endset %}
...
<div class="flex flex-wrap gap-2 my-6">
  ...
  <a class="badge-outline" href="https://github.com/social-5h3ll/5h3ll-ui/blob/main/src/js/range.js" target="_blank">
    range.js
    {% lucide "arrow-right" %}
  </a>
</div>
...
<section class="prose">
  ...
  <p>5H3LL-UI intentionally uses the native range input. Unlike shadcn/ui's Base UI slider, it does not support multiple thumbs or vertical orientation.</p>
</section>
