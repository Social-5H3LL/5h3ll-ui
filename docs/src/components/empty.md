...
<section class="prose">
  <p>Use <code>.empty</code> on a semantic container. The component styles common children like <code>&lt;header&gt;</code>, <code>&lt;figure&gt;</code>, headings, descriptions, and <code>&lt;footer&gt;</code>.</p>
</section>

<h3 id="usage-html"><a href="#usage-html">HTML</a></h3>

{{ code_block(code_default) }}
...
<section class="prose">
  ...
  <dl>
    ...
    <dd>The empty-state container.
      <dl>
        <dt><code class="highlight language-html">&lt;header&gt;</code></dt>
        <dd>Groups the media, title, and description.
          <dl>
...
<section class="empty">
  <header>
    <figure class="-space-x-2 [&_img]:ring-background [&_img]:ring-2 [&_img]:grayscale [&_img]:size-12 [&_img]:rounded-full">
      <img alt="@jane-doe" src="https://avatars.githubusercontent.com/u/270819256?v=4">
      <img alt="@shadcn" src="https://github.com/shadcn.png">
...
{{ code_preview("empty-rtl", code_rtl) }}
