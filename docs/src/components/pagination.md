...
<div class="alert mb-6">
  {% lucide "circle-alert" %}
  <h2>There is no dedicated pagination component in 5H3LL-UI.</h2>
</div>
...
<section class="prose">
  <p>A pagination is fairly simple to implement with Tailwind using the 5H3LL-UI button classes:</p>
</section>
