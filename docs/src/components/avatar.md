...
<div class="alert mb-6">
  {% lucide "circle-alert" %}
  <h2>There is no dedicated Avatar component in 5H3LL-UI.</h2>
</div>

{% set code %}
<div class="flex flex-row flex-wrap items-center gap-12">
  <img class="size-8 shrink-0 object-cover rounded-full" alt="@jane-doe" src="https://avatars.githubusercontent.com/u/270819256?v=4">
