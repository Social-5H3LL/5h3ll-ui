...
<div class="alert mb-6">
  {% lucide "circle-alert" %}
  <h2>There is no dedicated Accordion component in 5H3LL-UI.</h2>
</div>
...
<p class="prose">5H3LL-UI already animates <code>&lt;details&gt;</code> elements by default. The example add some Tailwind CSS utility classes for style and a bit of vanilla JavaScript to handle the open/close state.</p>