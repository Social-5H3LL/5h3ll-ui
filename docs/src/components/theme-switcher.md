...
<div class="alert mb-6">
  {% lucide "circle-alert" %}
  <h2>There is no dedicated theme switcher component in 5H3LL-UI.</h2>
...
<section class="prose">
  <p>To change the theme, you need to dispatch a <code>ui5h3ll:theme</code> event:</p>
</section>
...
<button type="button" onclick="document.dispatchEvent(new CustomEvent('ui5h3ll:theme'));">Toggle theme</button>
<!-- Sets the theme to dark -->
<button type="button" onclick="document.dispatchEvent(new CustomEvent('ui5h3ll:theme', { detail: { mode: 'dark' } }));">Set dark theme</button>{% endset %}
