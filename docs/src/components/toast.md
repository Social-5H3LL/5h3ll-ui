...
{% set code_client_side %}<button
  class="btn-outline"
  onclick="document.dispatchEvent(new CustomEvent('ui5h3ll:toast', {
    detail: {
      config: {
        category: 'success',
        title: 'Success',
...
<script src="https://cdn.jsdelivr.net/npm/@social-5h3ll/5h3ll-ui@{{ pkg.version }}/dist/js/toast.min.js" defer></script>{% endset %}
...
<div class="flex flex-wrap gap-2 my-6">
  ...
  <a class="badge-outline" href="https://github.com/social-5h3ll/5h3ll-ui/blob/main/src/js/toast.js" target="_blank">
    toast.js
    {% lucide "arrow-right" %}
  </a>
</div>
...
<section class="prose">
  <p>If you need to create a toast from the front-end, you can dispatch a custom <code>ui5h3ll:toast</code> event as such:</p>
</section>
...
<section class="prose">
  <dl>
    ...
    <dd>Once the component is fully initialized, it dispatches a custom (non-bubbling) <code>ui5h3ll:initialized</code> event on the <code>toaster</code> element.</dd>
    <dt><code>ui5h3ll:toast</code></dt>
    <dd>
      <p>The <code>toaster</code> listens for <code>ui5h3ll:toast</code> events on <code>document</code> to create toasts. The event's <code>detail</code> object must contain a <code>config</code> object (see <a href="#usage-html-js-6">JavaScript config object</a> below).</p>
    </dd>
  </dl>
</section>
...
<div class="flex flex-wrap gap-2 my-6">
  ...
  <a class="badge-outline" href="https://github.com/social-5h3ll/5h3ll-ui/blob/main/src/jinja/toast.html.jinja" target="_blank">
    Jinja macro
    {% lucide "arrow-right" %}
  </a>
  <a class="badge-outline" href="https://github.com/social-5h3ll/5h3ll-ui/blob/main/src/nunjucks/toast.njk" target="_blank">
    Nunjucks macro
    {% lucide "arrow-right" %}
  </a>
</div>
...
{{ toast(
  ...
  description="Sun, Dec 3, 2023 at 9:00 AM",
  cancel={ label: "Undo" }
) }}{% endraw %}{% endset %}
