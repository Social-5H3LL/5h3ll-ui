...
<section class="prose">
  <p>5H3LL-UI popovers are inline-positioned relative to the <code>.popover</code> wrapper. This differs from shadcn/ui's portalled Base UI implementation, but keeps the markup dependency-free and works with 5H3LL-UI's existing dropdown/select positioning model.</p>
</section>
...
<script src="https://cdn.jsdelivr.net/npm/@social-5h3ll/5h3ll-ui@{{ pkg.version }}/dist/js/popover.min.js" defer></script>{% endset %}
...
<div class="flex flex-wrap gap-2 my-6">
  ...
  <a class="badge-outline" href="https://github.com/social-5h3ll/5h3ll-ui/blob/main/src/js/popover.js" target="_blank">
    popover.js
    {% lucide "arrow-right" %}
  </a>
</div>
...
<section class="prose">
  <dl>
    ...
    <dd>Once the component is initialized, it dispatches a custom non-bubbling <code>ui5h3ll:initialized</code> event on itself.</dd>
...
<div class="flex flex-wrap gap-2 my-6">
  ...
  <a class="badge-outline" href="https://github.com/social-5h3ll/5h3ll-ui/blob/main/src/jinja/popover.html.jinja" target="_blank">
    Jinja macro
    {% lucide "arrow-right" %}
  </a>
  <a class="badge-outline" href="https://github.com/social-5h3ll/5h3ll-ui/blob/main/src/nunjucks/popover.njk" target="_blank">
    Nunjucks macro
    {% lucide "arrow-right" %}
  </a>
</div>
