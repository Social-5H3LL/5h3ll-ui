...
<form class="grid gap-4">
  <div class="grid gap-3">
    ...
    <input class="input" type="text" value="social-5h3ll" id="demo-dialog-edit-profile-name" autofocus>
  </div>
  <div class="grid gap-3">
    <label class="label" for="demo-dialog-edit-profile-username">Username</label>
    <input class="input" type="text" value="@social5h3ll" id="demo-dialog-edit-profile-username">
  </div>
</form>
{% endcall %}
{% endset %}
...
<section class="prose">
  <p>5H3LL-UI uses the native <code>&lt;dialog&gt;</code> element and <code>showModal()</code>. This differs from shadcn/ui's portalled Base UI implementation, but preserves native modality, focus handling, and inert page content without component JavaScript.</p>
</section>
...
<section class="prose">
  ...
  <dl>
    ...
    <dd>Trigger button. 5H3LL-UI intentionally uses the native <code>HTMLDialogElement.showModal()</code> method.</dd>
...
<div class="flex flex-wrap gap-2 my-6">
  ...
  <a class="badge-outline" href="https://github.com/social-5h3ll/5h3ll-ui/blob/main/src/jinja/dialog.html.jinja" target="_blank">
    Jinja macro
    {% lucide "arrow-right" %}
  </a>
  <a class="badge-outline" href="https://github.com/social-5h3ll/5h3ll-ui/blob/main/src/nunjucks/dialog.njk" target="_blank">
    Nunjucks macro
    {% lucide "arrow-right" %}
  </a>
</div>
...
<section class="prose">
  <dl>
    ...
    <dd>Action area. Use 5H3LL-UI button classes for actions.</dd>
