...
<script src="https://cdn.jsdelivr.net/npm/@social-5h3ll/5h3ll-ui@{{ pkg.version }}/dist/js/combobox.min.js" defer></script>{% endset %}
...
<div class="flex flex-wrap gap-2 my-6">
  ...
  <a class="badge-outline" href="https://github.com/social-5h3ll/5h3ll-ui/blob/main/src/js/combobox.js" target="_blank">
    combobox.js
    {% lucide "arrow-right" %}
  </a>
</div>
...
<div class="flex flex-wrap gap-2 my-6">
  ...
  <a class="badge-outline" href="https://github.com/social-5h3ll/5h3ll-ui/blob/main/src/jinja/combobox.html.jinja" target="_blank">
    Jinja macro
    {% lucide "arrow-right" %}
  </a>
  <a class="badge-outline" href="https://github.com/social-5h3ll/5h3ll-ui/blob/main/src/nunjucks/combobox.njk" target="_blank">
    Nunjucks macro
    {% lucide "arrow-right" %}
  </a>
</div>
