...
<section class="prose">
  ...
  <p>5H3LL-UI tooltips are CSS-only and text-only. This intentionally differs from shadcn/ui's composed tooltip content, which can render arbitrary markup and uses a portal.</p>
</section>
