...
<section class="prose">
  <p>shadcn/ui's Command component is built on <code>cmdk</code>. 5H3LL-UI implements the same command-menu pattern with vanilla HTML, CSS, and a small JavaScript controller for filtering, active item navigation, and dialog closing.</p>
</section>
...
<script src="https://cdn.jsdelivr.net/npm/@social-5h3ll/5h3ll-ui@{{ pkg.version }}/dist/js/command.min.js" defer></script>{% endset %}
...
<div class="flex flex-wrap gap-2 my-6">
  ...
  <a class="badge-outline" href="https://github.com/social-5h3ll/5h3ll-ui/blob/main/src/js/command.js" target="_blank">
    command.js
    {% lucide "arrow-right" %}
  </a>
</div>
...
<div class="flex flex-wrap gap-2 my-6">
  ...
  <a class="badge-outline" href="https://github.com/social-5h3ll/5h3ll-ui/blob/main/src/jinja/command.html.jinja" target="_blank">
    Jinja macro
    {% lucide "arrow-right" %}
  </a>
  <a class="badge-outline" href="https://github.com/social-5h3ll/5h3ll-ui/blob/main/src/nunjucks/command.njk" target="_blank">
    Nunjucks macro
    {% lucide "arrow-right" %}
  </a>
</div>
